...
if(MINGW)
  ...
  hunter_default_version(Boost VERSION 1.87.0)
endif()
...
hunter_default_version(LLD VERSION 17.0.6)
hunter_default_version(LLVM VERSION 17.0.6)
...
hunter_default_version(OpenSSL VERSION 1.1.1w)
...
if (APPLE)
  hunter_default_version(ZLIB VERSION 1.3.0-p1-mac)
else()
...
hunter_default_version(benchmark VERSION 1.9.0)
hunter_default_version(bento4 VERSION 1.5.1-628-e6ee435-p0)
hunter_default_version(binaryen VERSION 1.38.28-patch.4)
...
hunter_default_version(erasure_coding_crust VERSION 0.0.10)
...
hunter_default_version(fmt VERSION 11.1.4)
...
hunter_default_version(libp2p VERSION 0.1.36)
...
hunter_default_version(libsecp256k1 VERSION 0.5.1)
...
hunter_default_version(lsquic VERSION 4.0.9-qdrvm-2)
...
hunter_default_version(qtils VERSION 0.1.1)
...
hunter_default_version(scale VERSION 2.0.1)
hunter_default_version(scelta VERSION 0.1.0-a0f4f70-p0)
hunter_default_version(schnorrkel_crust VERSION 1.0.11)
...
hunter_default_version(soralog VERSION 0.2.5)
...
hunter_default_version(wabt VERSION 1.0.36)
